...
public class ModTags
{
    public static class Blocks
    {
        ...
        {
            return TagKey.of(RegistryKeys.BLOCK, Identifier.of(AestheticSurfaces.MOD_ID, name));
        }
    }
    ...
    public static class Items
    {
        ...
        {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of(AestheticSurfaces.MOD_ID, name));
        }
    }
}