...
public class ModTags
{
    public static class Blocks
    {
        ...
        {
            return TagKey.of(Registry.BLOCK.getKey(), new Identifier(AestheticSurfaces.MOD_ID, name));
        }
    }
    ...
    public static class Items
    {
        ...
        {
            return TagKey.of(Registry.ITEM.getKey(), new Identifier(AestheticSurfaces.MOD_ID, name));
        }
    }
}