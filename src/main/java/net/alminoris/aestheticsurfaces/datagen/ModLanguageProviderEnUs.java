    ...
    public void generateTranslations(TranslationBuilder translationBuilder)
    {
        Registry.BLOCK.stream()
                .filter(block ->
                {
                    ...
                    return AestheticSurfaces.MOD_ID.equals(id.getNamespace());
                })
                .forEach(block ->
                {
                    Identifier id = Registry.BLOCK.getId(block);
                    ...
                    translationBuilder.add("block." + AestheticSurfaces.MOD_ID + "." + path, displayName);
                });

        translationBuilder.add("itemGroup.aestheticsurfaces.asurftab", "Aesthetic Surfaces");
    }
