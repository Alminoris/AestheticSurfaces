...
{
    public static final ItemGroup ASURF_TAB =
            FabricItemGroup.builder( Identifier.of(AestheticSurfaces.MOD_ID, "asurftab")).displayName(Text.translatable("itemgroup.asurftab"))
